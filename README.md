# behavioral-analysis-vr

VR task analysis: trial loading, kinematics, UPDRS, and behavioral statistics.

## Scope

This repository contains **VR / behavioral analysis only** (kinematics, task events, clinical scores). Code that links VR data to neural signals lives in the matching `cross-modal-*` repository.
